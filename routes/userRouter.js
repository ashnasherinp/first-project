...
router.get('/auth/google/callback', passport.authenticate('google', {successRedirect: '/googleSuccess', failureRedirect:'/signup'}),(req,res) => {
    res.redirect('/')
})

router.get('/googleSuccess', userController.googleSuccess)
